...
public:
    ...
    /** Gets the source of the wind-speed */
    void GetWindSpeedSource(std::string &str) const;
    ...
    /** Gets the source of the wind-direction */
    void GetWindDirectionSource(std::string &str) const;
    ...
    /** Gets the source of the plume-height */
    void GetPlumeHeightSource(std::string &str) const;
