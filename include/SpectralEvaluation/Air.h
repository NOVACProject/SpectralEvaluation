...
#ifndef SPECTRALEVALUATION_AIR_H
#define SPECTRALEVALUATION_AIR_H

// Refractive index of air, as calculated by the formula from Edlén [Edlén, Journal of the Optical Society of America, 1953]
inline double RefractiveIndexOfAir_Edlen(double nmVac)
{
    const double sigma_vac_2 = 1e-2 / (nmVac * nmVac);
    return 1.0 + 1e-8 * (6432.8 + 2949810.0 / (146.0 - sigma_vac_2) + 25540 / (41.0 - sigma_vac_2));
}
...
#endif  // SPECTRALEVALUATION_AIR_H