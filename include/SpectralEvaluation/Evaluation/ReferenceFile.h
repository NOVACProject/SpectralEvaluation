...
public:
    ...
    /** This checks that the values of the current reference are OK in the provided index interval.
        If the reference contains any NaN or is constant in the given interval then a InvalidReferenceException is thrown. */
    void VerifyReferenceValues(int fromIndex, int toIndex) const;
