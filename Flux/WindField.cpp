...
void CWindField::GetWindSpeedSource(std::string &str) const {
...
/** Gets the source of the wind-direction */
void CWindField::GetWindDirectionSource(std::string &str) const {
...
/** Gets the source of the plume-height */
void CWindField::GetPlumeHeightSource(std::string &str) const {
