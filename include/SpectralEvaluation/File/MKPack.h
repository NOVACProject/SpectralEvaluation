...
struct MKZYhdr
{
    ...
    std::uint8_t flag;             // for further use, currently contains the status of the solenoid(s) in bit 0 and 1
...
public:
    ...
    long UnPack(const std::vector<std::uint8_t>& inpek, long kvar, std::vector<long>& ut) const;
