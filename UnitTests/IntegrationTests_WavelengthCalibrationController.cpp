...
namespace novac
{
        ...
        "[NovacProgramWavelengthCalibrationController][WavelengthCalibrationController][IntegrationTest][LongRunningTest]")
    {
        ...
        {
            REQUIRE(sut.m_resultingCalibration->pixelToWavelengthMapping[500] == Approx(319.764).margin(0.2));
            REQUIRE(sut.m_resultingCalibration->pixelToWavelengthMapping[700] == Approx(335.290).margin(0.2));
            REQUIRE(sut.m_resultingCalibration->pixelToWavelengthMapping[900] == Approx(350.249).margin(0.2));
        }
